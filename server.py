...
app = Flask(__name__)
CORS(app)  # Allows the browser extension to communicate with this API safely

# --- CONFIGURATION OPTIONS ---
SOLVE_MODE = "words"  # Options: "words", "numbers", "all"
# ----------------------------

# Dynamic temporary paths for Linux/Cloud hosting environments
...
def solve_base64():
    ...
    try:
        # Decode the Base64 audio string and write to cloud /tmp directory
        audio_bytes = base64.b64decode(data["audio_base64"])
        with open(MP3_FILE, "wb") as f:
            f.write(audio_bytes)
        
        # Process the decoded MP3 file
        sound = AudioSegment.from_mp3(MP3_FILE)
        
        try:
            # Bandpass filtering (150Hz - 3000Hz) to isolate vocal signals
...
if __name__ == "__main__":
    # Host providers dynamically assign the PORT variable
